...
data_ip="https://raw.githubusercontent.com/clock69/Perizinan/main/IP"
checking_sc() {
  ...
  if [[ $date_list < $useexp ]]; then
    ...
    echo -e "      \033[0;36mTelegram${NC} t.me/Kwnlm"
    echo -e "      ${GREEN}WhatsApp${NC} wa.me/6283847988185"
    echo -e "\033[1;93m────────────────────────────────────────────\033[0m"
    exit
  fi
}
...
Exp=$(curl -sS https://raw.githubusercontent.com/clock69/Perizinan/main/IP | grep $MYIP | awk '{print $3}')
fi
